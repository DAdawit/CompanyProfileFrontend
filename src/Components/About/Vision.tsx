  ...
  return (
    ...
    <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
      ...
      <div className="grid gap-8 md:grid-cols-2 md:gap-10">
        <img src="https://img.freepik.com/free-photo/business-strategy-success-target-goals_1421-33.jpg?uid=R190071028&ga=GA1.1.986869192.1741105703&semt=ais_hybrid" alt="" className="inline-block h-full w-full rounded-2xl object-cover" />
