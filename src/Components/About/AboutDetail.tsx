		...
		<section>
		  <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
		    <div className="flex flex-col gap-14 lg:gap-20">
		      <img src="https://img.freepik.com/free-photo/plan-planning-strategy-bysiness-ideas-concept_53876-132300.jpg?uid=R190071028&ga=GA1.1.986869192.1741105703&semt=ais_hybrid" alt="" className="w-full" />
		      <div className="flex flex-col gap-14 lg:gap-20">
